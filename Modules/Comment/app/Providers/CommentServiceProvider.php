...
namespace Comment\App\Providers;
...
class CommentServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Comment\App\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(base_path('Modules/Comment/routes/web.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::prefix('api')
            ->middleware('api')
            ->namespace($this->namespace)
            ->group(base_path('Modules/Comment/routes/api.php'));
    }
    ...
    protected function mapMobileRoutes()
    {
        Route::prefix('v1')
            ->namespace($this->namespace)
            ->group(base_path('Modules/Comment/routes/mobile.php'));
    }
